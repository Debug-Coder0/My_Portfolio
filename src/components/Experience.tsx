    ...
    <section id="work" className="py-[110px]">
      <div className="max-w-[1040px] mx-auto px-[22px]">
        ...
        <div className="flex flex-col gap-[22px] max-w-[880px] mx-auto">
          {experiences.map((exp) => (
            <article key={exp.id} className="bg-card border border-line-soft rounded-[22px] p-[34px] md:p-[38px] hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(0,0,0,0.07)] transition-all duration-300">
