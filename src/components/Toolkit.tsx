    ...
    <section id="skills" className="py-[110px]">
      <div className="max-w-[1040px] mx-auto px-[22px]">
        ...
        <motion.div 
          ...
          className="grid grid-cols-1 md:grid-cols-2 gap-[18px] max-w-[900px] mx-auto"
        >
          {/* Languages */}
          <motion.div variants={itemVariants} className="bg-card border border-line-soft rounded-[20px] p-[28px_30px] hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(0,0,0,0.07)] transition-all duration-300">
