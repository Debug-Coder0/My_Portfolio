    ...
    <section id="projects" className="py-[110px] bg-bg-alt">
      <div className="max-w-[1040px] mx-auto px-[22px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px]">
          {projects.map((proj) => (
            <article key={proj.id} className="bg-card rounded-[28px] p-[44px] md:p-[42px] border border-line-soft min-h-[320px] flex flex-col hover:-translate-y-1 hover:shadow-[0_22px_50px_rgba(0,0,0,0.08)] transition-all duration-300">
